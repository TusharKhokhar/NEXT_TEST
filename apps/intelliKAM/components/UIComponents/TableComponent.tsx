...
const TableComponents: React.FC<TableProps> = () => {
  ...
  const filteredData = data
    ...
    .filter((item) =>
      item.prospectCompany.toLowerCase().includes(filters.prospectCompany.toLowerCase())
    )
    ...
    <div className="max-w-full mx-auto py-6 sm:px-6 lg:px-8 mt-[3%]">
      ...
      <div className="flex justify-between items-center mt-4">
        ...
        <div className="relative text-gray-400 focus-within:text-gray-600">
          {/* Job title filter */}
          <input
            className="block w-48 pl-10 pr-3 py-2 rounded-md text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
            style={{ backgroundColor: '#E8EDEF' }}
            type="text"
