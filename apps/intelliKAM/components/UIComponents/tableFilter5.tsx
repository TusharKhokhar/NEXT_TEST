...
const TableComponents5: any = (props:any) => {
  const {usersPerPage,accessToken, globalSearch, setGlobalSearch,filterGlobalSearch, filteredData,setfilteredData,
    allData,
    setAllData,
    contacts,
    setContacts,
  ...
  //       const refreshTokenData: any = await axios.post('/api/salesforce/authentication', {
  //         body: {
  //           code: code,
  //         },
  //       })
            ...
            <div className="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {filteredData ? 
                    filteredData.slice(pagesVisited, pagesVisited + usersPerPage)
...
export default TableComponents5
